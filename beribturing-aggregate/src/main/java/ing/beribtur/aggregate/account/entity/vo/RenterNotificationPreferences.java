...
@Getter
@NoArgsConstructor
public class RenterNotificationPreferences extends NotificationPreferences {
    ...
    public RenterNotificationPreferences(EmailNotifications emailNotifications, PushNotifications pushNotifications, 
    ...
    public static RenterNotificationPreferences createDefault() {
        return new RenterNotificationPreferences(
