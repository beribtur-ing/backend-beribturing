...
public class JsonUtil {
    ...
    private static ObjectMapper getObjectMapper() {
        ObjectMapper mapper = ((JsonMapper.Builder)((JsonMapper.Builder)((JsonMapper.Builder)((JsonMapper.Builder)JsonMapper.builder().enable(new MapperFeature[]{MapperFeature.PROPAGATE_TRANSIENT_MARKER})).disable(new DeserializationFeature[]{DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES})).disable(new SerializationFeature[]{SerializationFeature.FAIL_ON_EMPTY_BEANS})).configure(Feature.WRITE_BIGDECIMAL_AS_PLAIN, true)).build();
